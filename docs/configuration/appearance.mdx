...
<ParamField path="grid_color" type="string">
  The color used for Month and Week Compact grid lines, Schedule dividers and hour lines, and Agenda dividers. Accepts any CSS color value, including hex colors and CSS variables. When omitted, the card keeps its light or dark default; transparent backgrounds use a readable translucent white.
