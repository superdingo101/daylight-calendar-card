...
description: "Use the uix.style option to inject raw CSS into Daylight Calendar Card's shadow DOM and override internal styling for events, days, and headers."
---
