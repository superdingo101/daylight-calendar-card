...
description: "Configure day_badges rules to display text labels, icons, or icon-and-text chips on calendar days matched by event title, calendar source, or day conditions."
---
