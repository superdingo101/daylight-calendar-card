...
export const TRANSLATIONS = {
  ...
  et: {
	  ...
	  strings: {
		...
		recurrenceEvery: 'Iga',
		recurrenceIntervalSuffix: 'intervall(i)',
		...
		recurrenceSelectWeekday: 'Vali vähemalt üks nädalapäev korduvate sündmuste jaoks',
		start: 'Algus',
		end: 'Lõpp',
		...
		descriptionPlaceholder: 'Sündmuse detailid...',
		cancel: 'Tühista',
		...
		editThisOccurrence: 'Muuda ainult seda esinemist',
		editThisOccurrenceAndFuture: 'Muuda seda ja kõiki tulevasi esinemisi',
		editEntireSeries: 'Muuda kogu seeriat',
		deleteThisEventOnly: 'Ainult see sündmus',
		deleteThisOccurrence: 'Kustuta ainult see esinemine',
		deleteThisAndFutureEvents: 'See ja tulevased sündmused',
		deleteThisOccurrenceAndFuture: 'Kustuta see ja tulevased esinemised',
		...
		googleCalendarLimitationTitle: 'ℹ️ Google Calendar piirang:',
		googleCalendarLimitationBody: 'Sündmuste muutmine ei ole Home Assistanti kaudu Google Calendaris toetatud. Saad neid kustutada, kuid muutmiseks kasuta Google Calendar rakendust või veebilehte.',
		...
		googleCalendarEditError: 'Google Calendar ei toeta Home Assistanti kaudu muutmist. Kasuta Google Calendar rakendust või veebilehte.',
